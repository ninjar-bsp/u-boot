...
static int gpio_init(void)
{
	...
	sunxi_gpio_set_cfgpin(SUNXI_GPD(13), SUNIV_GPD_UART2);
	sunxi_gpio_set_cfgpin(SUNXI_GPD(14), SUNIV_GPD_UART2);
	sunxi_gpio_set_pull(SUNXI_GPD(13), SUNXI_GPIO_PULL_UP);
